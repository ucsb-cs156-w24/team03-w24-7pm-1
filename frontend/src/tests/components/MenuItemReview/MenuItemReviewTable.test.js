...
describe("UserTable tests", () => {
  ...
  test("Has the expected column headers and content for ordinary user", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <MenuItemReviewTable reviews={menuItemReviewFixtures.threeReview} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>
  ...
  test("Delete button calls delete callback", async () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-itemId`)).toHaveTextContent("101");
