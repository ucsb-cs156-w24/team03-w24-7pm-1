...
describe("UserTable tests", () => {
  ...
  test("Has the expected column headers and content for ordinary user", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <RecommendationRequestTable dates={recommendationRequestFixtures.threeRequest} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>
  ...
  test("Delete button calls delete callback", async () => {
    ...
    expect(await screen.findByTestId(`RecommendationRequestTable-cell-row-0-col-id`)).toHaveTextContent("1");
