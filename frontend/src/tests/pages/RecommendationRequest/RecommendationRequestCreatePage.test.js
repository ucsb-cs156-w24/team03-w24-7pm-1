...
describe("RecommendationRequestCreatePage tests", () => {
    ...
    test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
        ...
        fireEvent.change(requesterEmailField, { target: { value: 'abc@def.com' } });
        fireEvent.change(professorEmailField, { target: { value: 'abc@asasdf.com' } });
        fireEvent.change(explanationField, { target: { value: 'pls' } });
        ...
        expect(mockToast).toBeCalledWith("New recommendationRequest Created - id: 17");
